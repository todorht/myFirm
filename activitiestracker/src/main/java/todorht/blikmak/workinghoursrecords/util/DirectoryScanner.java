...
public class DirectoryScanner {
    ...
    private void store(String line) {
        ...
        this.activityInformationRepository.saveAndFlush(new ActivityInformation(localDateTime,
                employeeCardService.findByCardNumber(parts[9]).get(),
                Integer.parseInt(String.valueOf(parts[20].charAt(0))) - 1));
